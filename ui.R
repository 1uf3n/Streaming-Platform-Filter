...
ui <- navbarPage("Analyzing Various Streaming Platforms",
                 tabPanel("Introduction",
                          ...
                          h2("Source"),
                          HTML("<a href='https://www.kaggle.com/datasets/ruchi798/movies-on-netflix-prime-video-hulu-and-disney' target='_blank'>The data source for our project can be found here.</a>")
                          ),
